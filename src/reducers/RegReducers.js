...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case REGISTRATION_UPDATE_GENDER_LOADING:
            return { ...state, updateGenderLoading: action.payload }
        case REGISTRATION_UPDATE_GENDER_ERROR:
            return {
                ...state,
                updateGenderLoading: false,
                updateGenderErrorMessage: action.payload,
            }
        case REGISTRATION_UPDATE_GENDER_SUCCESS:
            return {
                ...state,
                updateGenderLoading: false,
                updateGenderErrorMessage: '',
