...
export const notHaveGender = 'not_have_gender'
...
export const auth = {
    ...
    async setNotHaveGender() {
        try {
            return await AsyncStorage.setItem(notHaveGender, `true`)
        } catch (err) {
            throw err
        }
    },
    async getNotHaveGender() {
        try {
            return await AsyncStorage.getItem(notHaveGender)
        } catch (err) {
            throw err
        }
    },
    async removeNotHaveGender() {
        try {
            return await AsyncStorage.removeItem(notHaveGender)
        } catch (err) {
            throw err
        }
    },
