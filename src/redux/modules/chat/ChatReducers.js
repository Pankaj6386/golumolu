...
export const CHAT_ROOM_GOMO_PLANNER_REF = 'chat_room_gomo_planner_ref'
...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case CHAT_ROOM_GOMO_PLANNER_REF: {
            let newState = _.cloneDeep(state)
            console.log('CHAT_ROOM_GOMO_PLANNER_REF', action.payload)
            return _.set(newState, `gomoPlannerRef`, action.payload)
        }
