    ...
    switch (action.type) {
        ...
        case SEARCH_REQUEST_DONE: {
            ...
            if (queryId === state.queryId) {
                ...
                newState[type].isSuggested = isSuggested
            }
            return { ...newState }
        }
        ...
        case SEARCH_CLEAR_STATE: {
            ...
            preload = _.get(newState, 'posts.preload')
            newState = _.set(newState, 'posts', { ...INITIAL_SEARCH_STATE })
            newState = _.set(newState, 'posts.preload', preload)
