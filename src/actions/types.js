...
export const LOGIN_SOCIAL_MEDIA_LOADING = 'login_social_media_loading'
export const LOGIN_SOCIAL_MEDIA_ERROR = 'login_social_media_error'

/* Registration Constants */
// General registration error
export const REGISTRATION_ERROR = 'registration_error'
export const REGISTRATION_BACK = 'registration_back'
export const REGISTRATION_UPDATE_GENDER_LOADING =
    'REGISTRATION_UPDATE_GENDER_LOADING'
export const REGISTRATION_UPDATE_GENDER_ERROR =
    'REGISTRATION_UPDATE_GENDER_ERROR'
export const REGISTRATION_UPDATE_GENDER_SUCCESS =
