...
import { getGenderNameByGender, getGenderNoun } from '../Utils/UserUtils'
...
class NoGoalPrompt extends Component {
    ...
    render() {
        const { name, visitedUser, token, isVisible, gender } = this.props
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {`Ask ${name} a question that can inspire ${getGenderNoun(
                                    gender
