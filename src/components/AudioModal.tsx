...
type State = {
    ...
    data: string | null
    close: boolean // Popup close function
}
...
class AudioModal extends React.Component<Props, State> {
    ...
    render() {
        // const { chatMessages } = this.props  // not used
        const { soundDuration } = this.state
        /**
         * data - if contains "data" string in data then the title will change.
         * Close - used to close the audio popup
         * setVoiceData  - sending the voice url path to create remainder screen.
         * setVoiceTime  - sending the voice time to create remainder screen.
         */
        const { data, Close, setVoiceData, setVoiceTime } = this.props
        return (
            <>
                            ...
                            >
                                ...
                                <DelayedButton
                                    onPress={() => {
                                        ...
                                        // sending voice time and url to create remainder screen.
                                        if (data === 'data') {
                                            setVoiceData(this.state.record)
                                            setVoiceTime(
