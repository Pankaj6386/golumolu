...
const NEWLY_CREATED_KEY = 'newly_created_goal_tooltip'
class OnBoardingTooltip extends Component {
    constructor(props) {
        super(props)
        this.state = {
            toolTipVisible: null,
            ...
            <>
                ...
                this.state.showTooltip ? (
                    ...
                    >
                        <ImageBackground
                            resizeMode="cover"
                            source={require('../asset/image/suggestionTooltip.png')}
                            style={{
                                width: wp('53%'),
                                height: 95,
                            }}
                        >
                            <View>
                                ...
                                >
                                    You can swipe on these blue bubbles to
                                    reveal more vision-expanding goal questions!
                                </Text>
                            </View>
                            <TouchableOpacity
                                onPress={async () => {
