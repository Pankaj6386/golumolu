...
import SilverBadgeToast from '../../components/SilverBadgeToast'

import TRIBE_TOAST from '../../asset/image/messageUI.png'
import {
    trackWithProperties,
    EVENT as E,
    track,
} from '../../monitoring/segment'
import CreateTribeTooltip from '../../components/CreateTribeTooltip'
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ paddingHorizontal: 10 }}>
                        <TouchableOpacity
                            ...
                            onPress={this.onPressCreateTribe}
                        >
                            <Text
                                style={[
                                    default_style.titleText_1,
    ...
    renderHeader() {
        return (
            ...
            >
                ...
                {this.props.isSilverBadgePlus2 ? (
                    <SilverBadgeToast
                        image={LionMascot}
                        heading={'Want to gain more exposure for your brand?'}
                        text1={'Create a Tribe!'}
                        text2={'To unlock this ability, get your Silver Badge!'}
                        text3={
                            'Simply set 3 goals and invite 3 friends - Start building your Tribe today!'
                        }
                        height={140}
                    />
                ) : (
            ...
            <MenuProvider skipInstanceCheck={true}>
                <View style={{ backgroundColor: color.GM_BACKGROUND, flex: 1 }}>
                    ...
                    {this.props.isSilverBadgePlus && (
                        <ProfileInfoTooltip
                            text={
                                'You now have the ability to create your own Tribe! Tap here.'
                            }
                            width={'55%'}
                            height={100}
                            padding={4}
...
const makeMapStateToProps = () => {
    ...
    const mapStateToProps = (state) => {
        ...
        const isSilverBadgePlus = level >= 3
        const isSilverBadgePlus2 = level < 3
