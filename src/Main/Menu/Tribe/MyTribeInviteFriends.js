...
class MyTribeInviteFriends extends Component {
        ...
        return (
            <>
                <UserCard
                    ...
                    disable={button === undefined ? false : true}
                />
    ...
    render() {
        ...
        console.log('this tribe', this.props.tribe)
        return (
            <MenuProvider
