...
import { getGenderNameByGender } from '../../Utils/UserUtils'
                ...
                >
                    <TouchableWithoutFeedback
                        onPress={() => {
                            console.log(
                                'noti_goalId',
                                typeof this.props.noti_goalId.owner
                            )
                            this.props.addNudge(
                                typeof this.props.noti_goalId.owner === 'object'
                                    ? this.props.noti_goalId.owner._id
                                    : this.props.noti_goalId.owner,
                                this.props.token,
                                NUDGE_TYPES.clarifyGoals,
                                null,
                                goalId != undefined
                                    ? goalId
                                    : this.props.noti_goalId._id
                            )
