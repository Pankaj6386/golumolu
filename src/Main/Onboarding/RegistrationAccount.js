...
import { wrapAnalytics, SCREENS, EVENT as E } from '../../monitoring/segment'
        ...
        return (
            ...
            >
                <GoogleButton
                    ...
                    onPress={() => {
                        this.props.logInWithSocialMediaAccount('google_login')
                    }}
                />
                {DEVICE_PLATFORM === 'ios' && (
                    <AppleButton
                ...
                >
                    {registerErrMsg || socialMediaError ? (
...
const mapStateToProps = (state) => {
    ...
    const { socialMediaLoading, socialMediaError } = state.auth
