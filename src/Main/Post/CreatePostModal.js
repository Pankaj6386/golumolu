...
import { resetHandleDueDateNotification } from '../../reducers/ReminderFormReducers'
...
class CreatePostModal extends Component {
    ...
    initializeForm() {
        ...
        if (this.props.selectedText) {
            initialVals.post = this.props.selectedText
        }
    ...
    handleCreate = () => {
        ...
        const callback = (props) => {
            ...
            this.resetForm()
            this.props.resetHandleDueDateNotification()
            this.close()
    ...
    renderMedia() {
        const { mediaRef, uploading, type } = this.props
    ...
    render() {
        ...
        const { profile } = user
        // let showPostProgress = mediaRef.split('FeedVideo/')[1]
...
const mapStateToProps = (state, props) => {
    ...
    const postVideotranscoding = state.goalSwiper.uploadPostVideo
