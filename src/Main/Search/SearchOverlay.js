...
import SearchBarTooltip from '../../Main/Common/SearchBarTooltip'
...
const titleText =
    'NEW! Search by name, profile info, goal, tribe or chat room. '
const titleText2 =
    'You can even search people who have a specific goal or people who might be able to help with those goals! '
...
class SearchOverlay extends Component {
    ...
    _renderScene = SceneMap({
        ...
        post: () => <PostSearch type="GeneralSearch" />,
    })
