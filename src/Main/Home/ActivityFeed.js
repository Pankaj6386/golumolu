...
class ActivityFeed extends Component {
        ...
        return (
            ...
            >
                ...
                <View style={{}}>
                    ...
                    >
                        Invite {3 - this.props.userInvitedFriendsCount} more
    ...
    renderItem = ({ item, index }) => {
        ...
        return (
            ...
            <ActivityCard
                ...
                tooltipItemId={this.state.tooltipItemId}
            />
            // </Animatable.View>
        )
    }
    ...
    render() {
        ...
        global.USER_ID = this.props.userLogedIn.user._id
        const { data, userInvitedFriendsCount, refreshing } = this.props

        const swiperItem = data.filter((item) => item.goalRef)
        this.setState({ tooltipItemId: swiperItem[0]?._id })
        // console.log('swiperItem', this.state.tooltipItemId)
            ...
            <>
                ...
                {!this.props.loading && !this.props.refreshing ? (
                    <>
                        ...
                        >
                            <HomeFeedToast />
                            {/* <OnBoardingTooltip goals={this.props.goals} /> */}
                            {/* </Animatable.View> */}
                        </View>
