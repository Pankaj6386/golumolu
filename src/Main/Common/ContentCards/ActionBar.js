...
import PROFIE_INFO from '../../../asset/image/messageUI.png'
                        ...
                        <ActionButtonGroup>
                            ...
                            {this.props.showClarifyButton ? (
                                <>
                                    <ProfileInfoTooltip
                                        text={
                                            'The more clearly your friends describe their goals, the better their chances of success. Clarifying a goal also makes it easier for you help them! Tap here to ask your friend to Clarify.'
                                        }
                                        width={'70%'}
                                        height={130}
                                        top={-120}
                                        right={100}
                                        infoKey={'clarify_info_tooltip'}
                                        image={PROFIE_INFO}
                                        padding={6}
                                        crossTop={16.5}
                                        crossRight={10}
...
const renderSummaryItem = (
    ...
    >
        ...
        >
            ...
            {reactions !== undefined ? (
                LikeImages.map((reaction) => {
                    return (
                        <Image
                            source={reaction}
                            style={[styles.likeIcon, summaryIconStyle]}
                        />
                    )
                })
            ) : (
            ...
            <Text
                style={[
                    reactions ? styles.summaryText2 : styles.summaryText,
                    summaryTextStyle,
                ]}
            >
                {itemCount}
