...
import { sendClarifyMessage } from '../../../redux/modules/feed/comment/CommentActions'
                            ...
                            <Text style={styles.title}>
                                {`Ask ${
                                    name && name.includes(' ')
                                        ...
                                        : name
                                } to clarify ${getGenderNameByGender(
                                    gender
                                )} goal:`}
                            </Text>
...
export default connect(mapStateToProps, { sendClarifyMessage, openGoalDetail })(
    ClarifyModal
)
