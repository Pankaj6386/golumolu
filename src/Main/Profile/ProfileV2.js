...
// import PROFIE_INFO from '../../asset/image/suggestionTooltip.png'
...
class ProfileV2 extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            isGoalNudgeButtonVisible: false,
    ...
    async componentDidUpdate(prevProps, nextProps) {
        ...
        if (!this.props.isSelf && !_.isEqual(prevProps, this.props)) {
            if (
                this.props.visitedUser !== '61ae2014cde34bea062172f7' &&
                this.props.visitedUser !== '61ae2018cde34bea06217301' &&
                this.props.visitedUser !== '61ae2017cde34bea062172ff' &&
                this.props.visitedUser !== '61ae2015cde34bea062172fc'
            ) {
        ...
        if (user._id) {
            try {
                ...
                this.setState({
                    ...
                    isGoalNudgeButtonVisible: createFirstGoal,
    ...
    renderItem = ({ item, index: itemIndex }) => {
        ...
        const { pageId, userId, navigationState, friendship } = this.props
    ...
    renderHeader(props) {
        ...
        const friendsGoalVisited = !props.isSelf && goals
        ...
        return (
            <View>
                ...
                >
                    ...
                    {friendsGoalVisited && (
                        <FriendsGoalsVisit name={firstName} gender={gender} />
                    )}
                </View>
                {renderContentCreationButtons
            ...
            <>
                ...
                >
                    ...
                    >
                        ...
                        } has no goals yet or goals are all set to Private. Nudge ${getGenderNoun(
                            this.props.user.gender
                        )} to make some goals visible to Friends.`}
                    </Text>
                    {this.state.isGoalNudgeButtonVisible && (
                        <DelayedButton
                            activeOpacity={0.6}
                            onPress={() => {
                                this.setState({
            ...
            <>
                ...
                >
                    ...
                    {/* {this.props.isSelf && (
                        <ProfileInfoTooltip
                            text={
                                'Take a moment to fill in your profile! You’ll meet more people this way.'
                            }
                            width={'54%'}
                            height={12}
                            top={225}
                            right={43}
                            infoKey={'profile_info_tooltip'}
                            image={PROFIE_INFO}
                            padding={5}
                            crossTop={15}
                            crossRight={12}
                    ...
                    <CustomTooltip
                        title={
                            'Take a moment to share your bio and story! You’ll be able to meet more people this way. Plus, it adds to your personal branding and credibility!\n'
                        }
                        imageSource={PROFIE_INFO}
                        bgStyle={{
                            width: Size(30),
                            height: Size(14),
                        }}
                        ...
                        tooltipConstant="profile_info_tooltipc"
                    />
                </MenuProvider>
            </>
        )
