...
import LocationIcon from '../../../asset/image/locationIcon.png'
import InvitedByIcon from '../../../asset/image/invitedByIcon.png'
import CalenderIcon from '../../../asset/image/calenderIcon.png'
...
import { COUNTRY_NAMES_BY_CODE } from '../../../Utils/countryConstant'
...
class ProfileDetailCard extends Component {
    ...
    renderImage = () => {
        // console.log('UPLOADINGGGGG', this.props.uploading)
        return (
    ...
    renderInvitedBy(invitedName, inviterId) {
        if (invitedName) {
            return (
                <View style={styles.itemContainerView}>
                    <Image
                        source={InvitedByIcon}
                        style={styles.invitedIconStyle}
                    />
                    <TouchableOpacity
                        onPress={() => this.props.openProfile(inviterId)}
                    >
                        <Text style={styles.textStyle}>
                            {`Invited by: `}
    ...
    renderJoinedDate(created) {
        if (created) {
            return (
                <View style={styles.itemContainerView}>
                    <Image source={CalenderIcon} style={styles.iconStyle} />
                    <Text style={styles.textStyle}>
                        {`Joined: `}
                        <Text style={styles.darkTextStyle}>{`${moment(
                            created
            ...
            <>
                <View onLayout={this.onLayout}>
                    ...
                    <View style={styles.containerStyle}>
                        ...
                        {this.renderCountry(country, city)}
                        {this.renderInvitedBy(invitedBy?.name, invitedBy?._id)}
                        {this.renderJoinedDate(created)}
                    </View>
                </View>
            </>
        )
...
const mapStateToProps = (state, props) => {
    ...
    // console.log('STATEEEEE', state.profile)
