...
import { checkIfNewlyCreated, refreshProfileData } from '../../actions'
...
class CreateGoalModal extends React.Component {
    constructor(props) {
        super(props)
        this.isReminderConfirmButtonClick = false
        this.isCustomReminderSelected = false
    ...
    handleCreate = () => {
        ...
        if (getGoalPrivacy) {
            ...
            return this.props.submitGoal(
                ...
                this.props.user._id,
                initializeFromState,
                this.isReminderConfirmButtonClick,
                this.isCustomReminderSelected,
                (createdGoal) => {
                    ...
                    /> */}
                            ...
                            <ReminderPopup
                                ...
                                onClose={(
                                    ...
                                    this.isReminderConfirmButtonClick = isButtonClicked
                                    this.isCustomReminderSelected = isCustomSelected
                                    this.setState({
                                        showReminderPopup: false,
                                    })
                                    this.handleCreate()
                                ...
                                endDate={
                                    this.props.formVals?.values?.endTime?.date
                                }
                                startDate={
                                    this.props.formVals?.values?.startTime?.date
                                }
                            />
                        </View>
                    </MenuProvider>
