...
import { getGeneratedNeeds } from '../../../actions/GeneratedAiActions'
import {
    selectedNeeds,
    clearGeneratedData,
} from '../../../reducers/GeneratedReducers'

class SuggestedNeedModal extends Component {
    constructor(props) {
        super(props)
        this.state = {
            isChecked: false,
    ...
    componentDidMount() {
        this.setState({ textInputs: this.props.generatedNeeds })
    }
        ...
        return (
            <>
                <Modal
                    ...
                    onModalWillHide={() => {
                        let selectedNeeds = this.state.textInputs
                        ...
                        this.props.selectedNeedsClose(selectedNeeds)
                    }}
                >
                    <View
                        style={{
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                needs. Tap on the text to edit.
                            </Text>
                            {this.props.loadingNeeds ? (
                                <>
...
SuggestedNeedModal = reduxForm({
    form: 'needsSuggestion',
