...
import { removeNotification } from '../../../redux/modules/notification/NotificationActions'
...
class SectionCardV2 extends Component {
    ...
    renderTextStuff(isCommentFocused, description) {
        ...
        const maxHeightStyle =
            Platform.OS === 'ios' ? { maxHeight: 67 } : { maxHeight: 72 }
    ...
    render() {
        ...
        // console.log('ITEMMMMMM', this.props.isNudge)
