...
import { openChallenges } from '../../../actions'

const { CheckIcon, QuestionIcon } = Icons
const DEBUG_KEY = '[ UI EarnBadgeModal ]'
const GOLD_CHALLENGE_URL = 'https://www.goalmogul.com/goldchallenge'
const SILVER_CHALLENGE_URL = 'https://www.goalmogul.com/silverchallenge'
const BRONZE_CHALLENGE_URL = 'https://www.goalmogul.com/bronzechallenge'
                            ...
                            {BadgeInfo.map((b) => {
                                ...
                                return (
                                    <BadgeInfoCard
                                        ...
                                        openGoldUrl={() =>
                                            Linking.openURL(GOLD_CHALLENGE_URL)
                                        }
                                        openBronzeUrl={() =>
                                            Linking.openURL(
                                                BRONZE_CHALLENGE_URL
                                            )
                                        }
                                    />
                                )
...
const BadgeInfo = [
    ...
    },
    {
        ...
        linkToPriceButton: () => {
            ...
            setTimeout(() => {
                Linking.openURL(BRONZE_CHALLENGE_URL)
            }, 500)
        },
    ...
    },
    {
        ...
        linkToPriceButton: () => {
            ...
            setTimeout(() => {
                // this.props.openChallenges(SILVER_CHALLENGE_URL)
                Linking.openURL(SILVER_CHALLENGE_URL)
            }, 500)
        },

        tier: 3,
        infoTextList: [
            { text: 'Set 3 Goals', hasBulletPoint: true },
            {
                text: 'Invite 3 friends who sign up for GoalMogul',
                hasBulletPoint: true,
            },
